...
$_SESSION['uname']=$uname;
	...
	{
	 $qry="select * from student_details where rollno='$uname' and  password='$password'";
...
<h3 class="heading text-center mb-sm-5 mb-3">Student Login</h3>
<p>
...
<form name="form1" method="post" action="">
  <table width="376" height="166" border="0" align="center">
    <tr>
      <td width="120"><div align="center">Rollno :</div></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><a href="student_register.php">New User Register Here... </a></td>
    </tr>
  </table>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
