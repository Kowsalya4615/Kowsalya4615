...
$qrys1="select id from  student_details ORDER BY id ASC";
...
$rdate=date("D-m-y");
 ...
 $qrys1="insert into student_details values($id,'$name','$rollno','$department','$address','$year','$fname','$mname','$phno','$mailid','$password','0','0')";
...
<h3 class="heading text-center mb-sm-5 mb-3">  Students Register </h3>
<p>
