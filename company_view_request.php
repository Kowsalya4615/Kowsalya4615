...
<h3 class="heading text-center mb-sm-5 mb-3">Job Request </h3>
<p>
...
<form name="form1" method="post" action="">
  ...
  <table width="1021" height="130" border="0" align="center">
    <tr>
      ...
      <td><div align="center"><strong>Resume</strong></div></td>
      <td><div align="center"><strong>Request</strong></div></td>
    </tr>
    <?php
	$qrys1="select * from  student_request where company='$uname' and status='waiting'";
    ...
    <tr>
      ...
      <td><div align="center"><a href="download.php?id=<?php echo $row['report'];?>">Download</a></div></td>
      <td><div align="center"><a href="company_view_request_1.php?id=<?php echo $row['id'];?>&sts=accept">Accept</a> /<a href="company_view_request_1.php?id=<?php echo $row['id'];?>&sts=reject"> Reject</a> </div></td>
    </tr>
    <?php
	  }
	  ?>
