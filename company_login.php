...
if(isset($_POST['submit'])) 
{
	...
	{
	 $qry="select * from compreg where username='$uname' and  pass='$password'";
...
<form name="form1" method="post" action="">
  ...
  <p align="center"><a href="company_register.php">New Company Registration</a></p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
</form>
<p> 
