...
<h3 class="heading text-center mb-sm-5 mb-3">Company Details </h3>
<p>
...
<form name="form1" method="post" action="">
  ...
  <table width="80%" height="130" border="0" align="center">
    <tr>
      ...
      <td><div align="center"><strong>Registered on </strong></div></td>
    ...
    <tr>
      ...
      <td><div align="center">
          <?php 
					echo $st=$row['reg_date'];
					
					?>
      </div></td>
      <td><div align="center"><a href="admin_view_company_delete.php?id=<?php echo $row['id'];?>">select</a></div></td>
    </tr>
    <?php
	  }
	  ?>
